...
// typeof undifined 출력시 undifined
// typeof null 출력시 object

// undifined == null : true(참)
let n: null = null;
let u: undefined = undefined;

// 6. any
// 자바스크립트와의 호환을 위해 any라는 이름의 타입을 제공합니다.
// 모든 타입의 값을 가질 수 있습니다. (모든 타입의 루트 타입이다, 최상위 타입)
let a: any = 0;
a = "hello";
a = true;
a = {};
...
const theBiggestInt = BigInt(554433333338632258);