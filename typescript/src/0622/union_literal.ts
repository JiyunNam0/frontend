...
let aa2 = (aaa > 5) ?  "5보다 큰수" : "5이하의 수";

//! 유니언과 리터럴

//? 유니언(union) : 값에 허용된 타입을 두개 이상의 가능한 타입으로 확장! 하는것
//? 내로잉(narrowing) : 값에 허용된 타입이 하나 이상의 가능한 타입이 되지 않도록 좁히!는것
...
let idol3 = Math.random() > 0.5 ? "LE SSERAFIM" : 123; //? 문자열과 넘버속성을 다 해결할수있는 애가 toString()

// idol3.toUpperCase(); -> toUpperCase() : 영문을 전부 대문자 or 소문자로 변경
// 'string | number' 형식에 'toUpperCase' 속성이 없습니다.

// idol3.toFixed(); -> toFixed() : 소수점 자리수 제한
...
// actor.toFixed(); //'toFixed' 속성이 'string' 형식에 없습니다.
...
//? undefined: 변수를 선언하고 값을 할당하지 않은 상태 -> typeof : undefined
//? null: 변수를 선언하고 빈 값을 할당한 상태(빈객체) -> typeof : object
// number : 모든 숫자형태
// string: 모든 문자열 형태
...
// let color: "rad" | "blue" | "green"| "gray";
// let color2: "rad" | "blue" | "green" | "gray";
// let color3: "rad" | "blue" | "green" | "gray";

// 기본형: type 새로운 이름 = 타입
type colors = "rad" |"blue"| "green"| "gray";
let color: colors;
let color2: colors;
let color3: colors;
